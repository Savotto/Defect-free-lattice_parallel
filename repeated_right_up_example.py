#!/usr/bin/env python
"""
Example script demonstrating the repeated sequence of right-edge alignment followed by
upward movement of atoms below the target zone.
"""
import numpy as np
...
def main():
    """Run a lattice simulation showing repeated right-up movements."""
    print("Repeated Right-Up Movement Demonstration")
    print("-------------------------------------")
    ...
    # Execute the rearrangement algorithm
